...
namespace QLDSV_TC
{
    public partial class frptBangDiemMH : DevExpress.XtraEditors.XtraForm
    {
        public frptBangDiemMH()
        {
            InitializeComponent();
        }
        ...
        private void frptBangDiemMH_Load(object sender, EventArgs e)
        {
        ...
        {
            rprtBangDiemMH rpt = new rprtBangDiemMH(cmbNienKhoa.Text.Trim(), Convert.ToInt32(numHocKy.Text.Trim()), cmbMonHoc.SelectedValue.ToString().Trim(), Convert.ToInt32(numNhom.Text.Trim()));
